...
module.exports.allProperties = async (req, res) => {
  try {
    ...
    const allProperties = await pool.query(`SELECT  p.property_id, p.property_name, p.description, p.price, p.host_id,  h.host_name, h.host_email, json_agg(i.image_url) AS images
